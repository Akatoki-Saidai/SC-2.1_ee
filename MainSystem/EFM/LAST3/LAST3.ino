        ...
        case 4:
        {
          ...
          else
          {
            ...
            case 2:
            {
              ...
              CanSatLogData.println(gps_time);
              CanSatLogData.println("Angle_gy270=");
              CanSatLogData.println(Angle_gy270);
              CanSatLogData.print("Angle_Goal");
              CanSatLogData.println(Angle_Goal);
              CanSatLogData.print("Angle_gps");
              CanSatLogData.println(Angle_gps);
              CanSatLogData.print("Angle_heading");
              CanSatLogData.println(Angle_heading);
              CanSatLogData.flush();
