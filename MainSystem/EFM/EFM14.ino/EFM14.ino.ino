   ...
   if (gps.location.isUpdated()) {//この中でgpsのデータを使わないと，うまく値が表示されない
    if (timeCounter1 > 0) {
        ...
        if (mySensor.accelUpdate() == 0) {
            accelX = mySensor.accelX() + 0.0;
            accelY = mySensor.accelY() + 0.0;
            accelZ = mySensor.accelZ() + 0.0;
            accelSqrt = mySensor.accelSqrt() + 0.0;
        }
            ...
            case 5:
                ...
                switch(phase_5){
                  case 5:
                    ...
                    CanSatLogData.print("GPS_TIME:");CanSatLogData.println(gps_time);
                    ...
                    if(ultra_distance < 500){
                      ...
                      CanSatLogData.print("GPS_TIME:");CanSatLogData.println(gps_time);
                      CanSatLogData.println("goal detected!");       
                      CanSatLogData.flush();                              
                    }
                    break;
                  ...
                  case 1:
                    ...
                    CanSatLogData.print("GPS_TIME:");CanSatLogData.println(gps_time);
                    CanSatLogData.println("moving for 5000[ms]");
                    CanSatLogData.flush();
                    time2 = millis();
                    forward();
                    if(time2 - time1 >= 5000){
                  ...
                  case 4:
                    ...
                    CanSatLogData.println("STOPPING PHASE");
                    CanSatLogData.print("GPS_TIME:");CanSatLogData.println(gps_time);
                    CanSatLogData.println("congratulations!");  
                    CanSatLogData.flush();
                    phase_5 = 6;
                    break;
