...
double GOAL_lat = 35.776975000;
double GOAL_lng = 139.655743333;
...
void setup() {
    ...
    CanSatLogData.flush();
    SensorData.println("gps_time,gps_latitude,gps_longitude,gps_velocity,Temperature,Pressure,accelX,accelY,accelZ,R,G,B,ultra_distance");
    SensorData.flush();
           ...
           //########## 待機フェーズ ##########
            ...
            case 3:
                if(phase_state != 3){
                    ...
                    //LogDataの保存
                    CanSatLogData.println(currentMillis);
                    CanSatLogData.println("WARNING: 9v voltage is output");
                    CanSatLogData.flush();
                    ...
                    case 2:{
                      ...
                      CanSatLogData.flush();
                        ...
                        if (llAngle > 20){
                          ...
                          CanSatLogData.print("rotating left for ");CanSatLogData.print(rotate_time);CanSatLogData.println("[ms]");
                          CanSatLogData.flush();
                          rotating();
                          delay(rotate_time);
                          stoppage();
